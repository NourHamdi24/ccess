  ...
  return (
    <div className="container  overflow-visible">
      <div className="grid grid-cols-1  lg:grid-cols-3 items-center justify-items-center lg:justify-items-normal lg:gap-50 xl:gap-0 relative  rounded-[50px] bg-linear-to-br from-[#3E78C5] to-[#1E3A5F]">
        <div className=" lg:relative w-80 lg:w-108 pt-2 xl:w-auto">
          <Image
            src="/ceo.png"
            alt="ceo"
            width={600}
        ...
        <div className="lg:col-span-2  xl:px-16 py-8 relative text-white">
          ...
          <div className="flex justify-evenly text-center md:text-start px-2 xl:px-0 lg:justify-start items-center gap-4 lg:gap-36 mt-4 w-full">
            <div className="">
            ...
            <Image
              ...
              width={64}
              height={64}
              className="w-10 h-10  lg:block lg:w-16 lg:h-16"
            />
          </div>
        </div>
      </div>
